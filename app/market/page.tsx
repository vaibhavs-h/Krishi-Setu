            ...
            <main className="flex-grow w-full max-w-[1400px] mx-auto px-8 py-4 relative z-10">
              <div className="mb-10 text-center md:text-left flex flex-col md:flex-row justify-between items-end">
                <div>
                  ...
                  <p className="text-gray-950 dark:text-gray-300 max-w-2xl text-sm md:text-base tracking-wide font-medium">Real-time crop valuation powered by predictive neural algorithms.</p>
                </div>
